...
print("data column info: {}".format(train.columns))
...
# text_a: 要分类的文本
# text_b: 当需要训练模型来理解句子间的关系时使用，如text_b是否是text_a的翻译或text_b是否是问题text_a的答案
...
tokenizer = create_tokenizer_from_hub_module() # tokenizer将words分解成WordPieces
print("tokenizer example of [This here's an example of using the BERT tokenizer]: {}".format(tokenizer.tokenize("This here's an example of using the BERT tokenizer")))

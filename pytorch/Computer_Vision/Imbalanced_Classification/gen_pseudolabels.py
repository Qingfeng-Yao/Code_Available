...
'''
python3 gen_pseudolabels.py --dataset cifar10 --loss_type CE --resume xxx
其中xxx格式如: checkpoint/cifar10_resnet32_CE_None_exp_0.01_ss_pretrained/ckpt.best.pth.tar
在未标记数据集ti_80M_selected.pickle上生成伪标签
'''
